...
# 1. CONFIGURACIÓN
st.set_page_config(page_title="DUSA - Calculadora de Alcohol", page_icon="🧪", layout="centered")
...
with tab1:
    ...
    c1, c2 = st.columns(2)
    with c1:
        grado_n = st.number_input("Grado Real (°GL):", 50.0, 100.0, value=None, 0.1, key="gn", format="%.1f")
    with c2:
...
with tab2:
    ...
    c1, c2 = st.columns(2)
    with c1:
        grado_i = st.number_input("Grado Real (°GL):", 50.0, 100.0, value=None, 0.1, key="gi", format="%.1f")
    with c2:
